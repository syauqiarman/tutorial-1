...
public class PaymentBankTransferTest {
    ...
    void testCreatePaymentBankTransferSuccessful() {
        ...
        Payment payment = new PaymentBankTransfer("02657834-7df4-4ad4-b164-4bb6be61cf7f", orders.get(0), PaymentMethod.BANK.getValue(), paymentDataBankTransfer);
    ...
    void testCreatePaymentBankTransferWithStatus() {
        ...
        PaymentBankTransfer paymentBankTransfer = new PaymentBankTransfer("02657834-7df4-4ad4-b164-4bb6be61cf7f",orders.get(0), PaymentMethod.BANK.getValue(), paymentDataBankTransfer, PaymentStatus.SUCCESS.getValue());
    ...
    void testCreatePaymentFailedEmptyBankName() {
        ...
        assertThrows(IllegalArgumentException.class, ()-> { 
            new PaymentBankTransfer("02657834-7df4-4ad4-b164-4bb6be61cf7f", orders.get(1),PaymentMethod.BANK.getValue(), paymentDataBankTransfer);
        });
    }
